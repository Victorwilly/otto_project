class RoutePaths {
  ...
  // static const String fipRequest = '/fipRequest';
  // static const String acceptRequest = '/acceptRequest';
  // static const String fipTwoFactor = '/fipTwoFactor';
  // static const String consentDetail = '/consentDetail';
  // static const String resumeContentOtp = '/resumeCntentOtp';
  // static const String manageConsent = '/manageConsent';
  // static const String consentLog = '/consentLog';
